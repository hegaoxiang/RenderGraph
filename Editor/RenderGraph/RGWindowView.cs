...
namespace Colorful.RenderGraph
{
    public class RGWindowView : EditorWindow
    {
        ...
        [MenuItem("BPipeline/OpenRenderGraph Editor")]
        ...
        private void OnEnable()
        {
            ...
            {
                m_RenderGraph = ScriptableObject.CreateInstance<RenderGraph>();
        ...
        public void Load(string path)
        {
            ...
            try
            {
                info = AssetDatabase.LoadAssetAtPath<RenderGraph>(path);
        ...
        public void Save()
        {
            ...
            }else
            {
                ...
                if (FileUtil.GetSaveFileName(openFileName))
                {
                    ...
                    if (m_RenderGraph == null)
                        m_RenderGraph = CreateInstance<RenderGraph>();
