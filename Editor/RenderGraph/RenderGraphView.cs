...
namespace Colorful.RenderGraph
{
    ...
    public class RenderGraphView : GraphView,IEdgeConnectorListener
    {
        ...
        public RenderGraphView(EditorWindow editorWindow, RenderGraph renderGraph) : base()
        {
        ...
        {
            RenderGraph.Port port = new RenderGraph.Port()
            {
        ...
        public void SetGraphInfo(RenderGraph bRenderGraph)
        {
